...
slack = Category.find_or_create_by(name: "slack")
...
SpotTemplate.find_or_create_by(name: "Team Alert").update_attributes(category: messaging, description: "Instantaneously inform the whole team whenever a work item is updated.")
SpotTemplate.find_or_create_by(name: "To Do to Calendar").update_attributes(category: calendar, description: "Have Google calendar events created whenever you add a Todoist item.")
SpotTemplate.find_or_create_by(name: "Slack notification").update_attributes(category: slack, description: "Get a notification on your Slack channel when a file is uploaded or modified.")
